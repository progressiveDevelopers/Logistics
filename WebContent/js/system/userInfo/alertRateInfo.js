...
/**
 *除法函数，用来得到精确的除法结果 * 说明：javascript的除法结果会有误差，
 * 在两个浮点数相除的时候会比较明显。这个函数返回较为精确的除法结果。
...
$(function() {
    ...
    $.ajax({
        ...
        success : function(data) {
            ...
            $.ajax({
                type : "GET",
                url : "/Logistics/userInfo/rateInfoDataTargetMonth.shtml?userId="+$('#userId').val()+"&monthId=2",
                success : function(data) {
                    data = JSON.parse(data)
                    console.log(data);
